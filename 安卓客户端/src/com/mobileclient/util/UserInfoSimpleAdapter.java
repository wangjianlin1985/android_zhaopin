...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_myShoolRecord = (TextView)convertView.findViewById(R.id.tv_myShoolRecord);
	  ...
	  holder.tv_myShoolRecord.setText("学历：" + (new SchoolRecordService()).GetSchoolRecord(Integer.parseInt(mData.get(position).get("myShoolRecord").toString())).getSchooRecordName());
	  holder.tv_schoolName.setText("毕业学校：" + mData.get(position).get("schoolName").toString());
	  holder.tv_workYears.setText("工作经验：" + mData.get(position).get("workYears").toString());
