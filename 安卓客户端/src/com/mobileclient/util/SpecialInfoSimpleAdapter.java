...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*绑定该view各个控件*/
	  holder.tv_specialId = (TextView)convertView.findViewById(R.id.tv_specialId);
	  holder.tv_specialName = (TextView)convertView.findViewById(R.id.tv_specialName);
	  /*设置各个控件的展示内容*/
	  holder.tv_specialId.setText("专业id：" + mData.get(position).get("specialId").toString());
