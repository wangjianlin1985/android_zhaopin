...
public class DeliveryStateDetailActivity extends Activity {
	// 声明返回按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.deliverystate_detail);
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("查看投递状态详情");
		...
		btnReturn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				DeliveryStateDetailActivity.this.finish();
			}
		}); 
		initViewData();
	}
	...
	private void initViewData() {
		...
		this.TV_stateId.setText(deliveryState.getStateId() + "");
		this.TV_stateName.setText(deliveryState.getStateName());
	} 
}
