			...
			public void onClick(View v) {
				try {
					...
					if(ET_schoolName.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "毕业学校输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workYears.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "工作经验输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "现居地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_qzyx.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "求职意向输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_gzjl.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "工作经历输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_jyjl.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "教育经历输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_zwpj.getText().toString().equals("")) {
						Toast.makeText(UserInfoAddActivity.this, "自我评价输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传求职者信息*/
					UserInfoAddActivity.this.setTitle("正在上传求职者信息，稍等...");
