				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new NewsSimpleAdapter(NewsListActivity.this, list,
	        					...
	        					new String[] { "newsId","newsClassObj","title","publishDate" },
	        					new int[] { R.id.tv_newsId,R.id.tv_newsClassObj,R.id.tv_title,R.id.tv_publishDate,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < newsList.size(); i++) {
				...
				map.put("newsClassObj", newsList.get(i).getNewsClassObj());
