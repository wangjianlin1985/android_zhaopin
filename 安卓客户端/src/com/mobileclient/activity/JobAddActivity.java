			...
			public void onClick(View v) {
				try {
					...
					if(ET_positionName.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "招聘职位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_personNum.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "招聘人数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_city.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "所在城市输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_salary.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "薪资待遇输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workYears.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "工作年限输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_workAddress.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "工作地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_welfare.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "福利待遇输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_positionDesc.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "岗位要求输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_connectPerson.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "联系人输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(JobAddActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传职位信息*/
					JobAddActivity.this.setTitle("正在上传职位信息，稍等...");
