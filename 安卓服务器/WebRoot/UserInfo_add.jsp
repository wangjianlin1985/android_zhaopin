...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>工作经验:</td>
    <td width=70%><input id="userInfo.workYears" name="userInfo.workYears" type="text" size="50" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>求职意向:</td>
    <td width=70%><textarea id="userInfo.qzyx" name="userInfo.qzyx" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>工作经历:</td>
    <td width=70%><textarea id="userInfo.gzjl" name="userInfo.gzjl" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>教育经历:</td>
    <td width=70%><textarea id="userInfo.jyjl" name="userInfo.jyjl" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>自我评价:</td>
    <td width=70%><textarea id="userInfo.zwpj" name="userInfo.zwpj" rows="5" cols="50"></textarea></td>
  </tr>
